...
const styles = StyleSheet.create({
  ...
  roleBadge: {
    color: '#0A0A0A', backgroundColor: '#E8C547', paddingHorizontal: 12,
    paddingVertical: 4, borderRadius: 20, fontSize: 13, fontWeight: '700', marginBottom: 8,
  },
  bio: { color: '#888', fontSize: 14, textAlign: 'center', lineHeight: 20, marginBottom: 20 },
  ...
  roleCircleText: { color: '#fff', fontSize: 11, fontWeight: '700' },
  ...
  roleLabel: { color: '#555', fontSize: 9, textAlign: 'center', flex: 1 },
